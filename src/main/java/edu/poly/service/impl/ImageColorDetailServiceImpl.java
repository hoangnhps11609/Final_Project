...
public class ImageColorDetailServiceImpl implements ImageColorDetailService{
	...
	@Override
	public List<ImageColorDetail> findAllById(Iterable<Long> ids) {
		return imageColorDetailDAO.findAllById(ids);
	}


	@Override
	public Optional<ImageColorDetail> findById(Long id) {
	...
	@Override
	public ImageColorDetail getOne(Long id) {
	...
	@Override
	public ImageColorDetail getById(Long id) {
	...
	@Override
	public Page<ImageColorDetail> findByColor(Integer color, Pageable pageable) {
		return imageColorDetailDAO.findByColor(color, pageable);
	}
